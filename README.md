...
> [!NOTE]
> Option 4 is designed to demonstrate the proper directory structure and the use of modules. This approach showcases how to quickly spin up different environments by leveraging various modules.
